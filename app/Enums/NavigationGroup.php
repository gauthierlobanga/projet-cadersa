...
enum NavigationGroup implements HasIcon, HasLabel
{
    ...
    public function getLabel(): string
    {
        return match ($this) {
            ...
            self::Vitrine => __('Vitrine'),
            self::Content => __('Contenu'),
            self::CRM => __('CRM'),
            self::World => __('Monde'),
    ...
    public function getIcon(): string|BackedEnum|Htmlable|null
    {
        return match ($this) {
            ...
            self::Vitrine => Heroicon::OutlinedPresentationChartLine,
            self::Content => Heroicon::OutlinedDocument,
            self::CRM => Heroicon::OutlinedUserGroup,
