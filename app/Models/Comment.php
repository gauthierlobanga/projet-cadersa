...
class Comment extends Model
{
    ...
    protected $fillable = [
        ...
        'likes_count', 'dislikes_count', 'replies_count', 'reports_count',
        'ip_address', 'user_agent', 'approved_at', 'edited_at',
    ];

    protected $appends = ['content_html', 'time_ago'];
    ...
    public const string STATUS_TRASHED = 'trashed';
