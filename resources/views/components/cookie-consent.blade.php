...
<div x-data="cookieConsent()" x-cloak>
    {{-- ===== BANNER ===== --}}
    <div x-show="show" x-ref="banner" class="fixed bottom-0 left-0 right-0 z-100 p-4 sm:p-6 pointer-events-none flex justify-center items-end h-0 overflow-visible">
